<main id="main" class="main">
    ...
    <div class="pagetitle">
        <h1>Tabel Daftar <?= $category['title']; ?></h1>
        <nav>
            <ol class="breadcrumb">
            ...
            <div class="col">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-6">
                                <a href="<?= base_url('Kategori/detail_add/' . $category['slug']); ?>"><button type="button" class="btn btn-primary mt-4"><i class="bi bi-folder me-1"></i> Tambah Data Karya</button></a>
                            </div>
                            <div class="col-lg-6 text-end">
                                <a href="<?= base_url('Kategori/edit/' . $category['slug']); ?>" class="btn btn-secondary mt-4"><i class="bi bi-collection me-1"></i> Edit Data</a>
                                <a href="<?= base_url('Kategori/delete/' . $category['slug']); ?>" class="btn btn-danger mt-4 tombol-hapus"><i class="bi bi-exclamation-octagon me-1"></i> Hapus Sub</a>
                            </div>
                        </div>

                        <h5 class="card-title">Daftar <?= $category['title']; ?></h5>
                        <div class="row mt-2">
                            <div class="col">
