                    ...
                    <div class="card-body">
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control <?= (form_error('quantity')) ? 'is-invalid' : ''; ?>" id="quantity" name="quantity" value="<?= (set_value('quantity')) ? set_value('quantity') : $art['quantity']; ?>">
