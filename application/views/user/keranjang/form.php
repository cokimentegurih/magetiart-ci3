            ...
            <div class="col">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <?php if (empty($products)) : ?>
                                    <tr>
                                        <td colspan="5" style="text-align:center;">Tidak ada produk di dalam keranjang belanja.</td>
                                    </tr>
                                <?php else : ?>
                                    <?php $i = 1;
                                    foreach ($products as $product) : ?>
                                        <tr class="text-center align-middle">
                                            ...
                                            <td style="width:20%;  color: #C24332;"><?= 'IDR ' . number_format("" . (float)intval(str_replace('.', '', trim($product['price'], "IDR"))) * (int)$products_in_cart[$product['id']] . "", 0, ",", "."); ?></td>
                                        </tr>
                                    <?php
                                        $i++;
                                    endforeach; ?>
                        ...
                        <div class="row justify-content-end">
                            <div class="col-3 text-center">
                                <p class="card-text"><?= 'IDR ' . number_format("" . $subtotal . "", 0, ",", "."); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
